        ...
        try {
            ...
            if (requestdata != '') {
                ...
                found_user = await drivers.findOne({
                    ...
                    attributes: ['id', 'email', 'firstName', 'lastName', 'username', 'countryCode', 'contactNo', 'countryCodePhone', 'loginType', 'image', 'socialId', 'socialType', 'city', 'country', 'deviceType', 'deviceToken', 'createdAt', [sequelize.fn('IFNULL', sequelize.col('updated_at'), ''), 'updated_at']]
                });
        ...
        try {
            ...
            if (requestdata != '') {
                ...
                let getUser = await drivers.findOne({
                    ...
                    attributes: ['id', 'email', 'password', 'username', 'countryCode', 'countryCodePhone', 'socialId', 'socialType', 'deviceType', 'deviceToken', 'createdAt', 'updatedAt']
                });
                if (!getUser) {
                    res.status(200).json({
                        'status': false,
    ...
    forgotPassword: async (req, res) => {
        try {
            ...
            if (requestdata != '') {
                ...
                // console.log(updateForgotPasswordHash);
                // return false;

                let forgotPasswordUrl = "www.bahamaeats.com/driver_reset_password/" + forgotPasswordHash;
