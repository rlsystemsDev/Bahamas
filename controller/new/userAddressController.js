        ...
        try {
            ...
            if (requestdata != '') {
                ...
                if (checkAddress != null) {
                    ...
                    const checkDefaultAddress = await UserAddress.findAll({
                        where: {
                            userId: req.user.id,
                            isDefault: 1
                        },
                    ...
                    console.log(checkDefaultAddress, '=====>checkDefault');
                    // return;

                    if (checkDefaultAddress.length == 0) {
                        const makeAddressDefault = await UserAddress.findOne({
                            where: {
                                userId: req.user.id,
                            },
                            order: [['id', 'DESC']],
